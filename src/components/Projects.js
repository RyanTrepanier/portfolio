 ...
 return (
    <section id="projects" className="text-gray-400 body-font">
        ...
        {/* <div className="container px-5 py-10 mx-auto text-center lg:px-40"> */}
            <div className="flex flex-wrap w-1/2 md:w-full mb-20">
                ...
                <AspectRatio ratio="3/4" style={{ minWidth: '100%'}}>
                    <img src={lumen} height='300px' width='300px' alt='Lumen' align='left'/>
                    {/* <Img src={lumen} /> */}
                ...
                <img src={calc} height='300px' width='300px' alt='Calculator' align='left'/>
                ...
                <img src={project} height='300px' width='300px' alt='Encryption' align='left'/>
