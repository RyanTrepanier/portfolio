    ...
    <section id="projects" className="text-gray-400 body-font">
        <div className="container px-5 py-10 mx-auto text-center lg:px-40">
            <div className="flex flex-col w-full mb-20">
                ...
                <img src={lumen} height='300px' width='300px' alt='Lumen' />
                <br />
                <br />
                <br />
                <br />
                ...
                <img src={calc} height='300px' width='300px' alt='Calculator' />
                <br />
                <br />
                <br />
                <br />
                ...
                <img src={project} height='300px' width='300px' alt='Encryption' />
            </div>
        </div>
    </section>
 );
